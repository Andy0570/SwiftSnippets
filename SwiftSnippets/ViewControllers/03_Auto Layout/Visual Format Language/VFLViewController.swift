...
/// 使用视觉化格式语言（Visual Format Language, VFL）添加自动布局约束
/// !!!: 在 VFL 中，相对于 Safe Area 该如何设置？
/// 参考:
/// * <https://www.hackingwithswift.com/read/6/3/auto-layout-in-code-addconstraints-with-visual-format-language>
/// * <https://manasaprema04.medium.com/auto-layout-with-visual-format-language-de720504b4b5>
class VFLViewController: UIViewController {
    override func viewDidLoad() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-104-[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: metrics, views: viewsDictionary))
    }
}
