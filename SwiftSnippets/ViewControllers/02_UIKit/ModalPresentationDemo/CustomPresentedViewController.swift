...
final class CustomPresentedViewController: UIViewController {
...
extension CustomPresentedViewController: UIAdaptivePresentationControllerDelegate {
    // 如果 isModalInPresentation = false，当拖拽时，系统会首先调用该方法
