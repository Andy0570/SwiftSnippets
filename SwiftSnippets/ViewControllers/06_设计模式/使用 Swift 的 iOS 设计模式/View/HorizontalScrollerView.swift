...
class HorizontalScrollerView: UIView {
    ...
    // 私有枚举类型，使代码布局在设计时更容易修改
    private enum ViewConstants {
        static let Padding: CGFloat = 10
        static let Dimensions: CGFloat = 100 // 视图尺寸 100*100
    ...
    private func initializeScrollView() {
        ...
        // 添加 tap 手势，检测 scrollView 上的触摸事件并检查是否已经点击了专辑封面
    ...
    // 当用户手指拖动 scrollView 时，计算以确保当前正在查看的专辑视图居中显示
