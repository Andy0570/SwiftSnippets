...
class PhotoCollectionViewController: UIViewController {
    ...
    var photos: [UIImage] = {
        return [
            UIImage(named: "fluidPhoto1").require(),
            UIImage(named: "fluidPhoto2").require(),
            UIImage(named: "fluidPhoto3").require(),
            UIImage(named: "fluidPhoto4").require(),
            UIImage(named: "fluidPhoto5").require(),
            UIImage(named: "fluidPhoto6").require(),
            UIImage(named: "fluidPhoto7").require(),
            UIImage(named: "fluidPhoto8").require(),
            UIImage(named: "fluidPhoto9").require(),
            UIImage(named: "fluidPhoto10").require(),
            UIImage(named: "fluidPhoto11").require(),
            UIImage(named: "fluidPhoto12").require(),
            UIImage(named: "fluidPhoto13").require(),
            UIImage(named: "fluidPhoto14").require(),
            UIImage(named: "fluidPhoto15").require(),
            UIImage(named: "fluidPhoto16").require(),
            UIImage(named: "fluidPhoto17").require(),
            UIImage(named: "fluidPhoto18").require()
        ]
    }()
